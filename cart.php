                ...
                <table class="table table-bordered table-hover table-md h5" name="SHOPPING_CART">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align:center;">
                            ...
                            ?>
                            <td colspan="3"><button type="submit" name="back" class="btn btn-warning my-3 row3" style="  color: #fff; background-color:#709192 !important; border-color: #709192;"><a href="" style="text-decoration: none;color:white;">Continue shopping <i class="fas fa-shopping-cart"></i></a></button></td>
                            <td>
                            ...
                            <td>
                                <button type="submit" name="sub" value="checkout" class="btn btn-success my-3 mx-1 row3 " style="  color: #fff; background-color:#709192 !important; border-color: #709192;">Proceed to Checkout<i class="fas fa-shopping-cart"></i></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
